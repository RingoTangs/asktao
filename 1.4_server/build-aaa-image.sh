...
echo "  docker run --rm --name at-1.4-aaa -p 8101:8101 -p 9101:9101 -e DB_HOST=your-db-host -e DB_USER=your-db-user -e DB_PASSWORD=your-db-password -v /home/at-1.4/aaa:/app ${IMAGE_NAME}"
echo
